            ...
            <div class="container mx-auto flex flex-wrap items-center justify-between">
                ...
                <div class="hidden lg:block w-full md:w-auto" id="mobile-menu">
                    <ul class="flex-col md:flex-row flex md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <li>
                            <a href="/pemanfaatan"
                                class="bg-[#3D7C17] hover:text-[#FFF100] md:bg-transparent {{ Route::currentRouteName() == 'pemanfaatan' ? 'text-white bg-[#3D7C17] text-sm' : 'text-white text-sm' }} rounded lg:bg-transparent  {{ Route::currentRouteName() == 'pemanfaatan' ? 'lg:text-[#FFF100]' : 'lg:text-grey-700' }} block pl-3 pr-4 py-2 md:p-0 rounded focus:outline-none">Pemanfaatan</a>
                        </li>
                        <li>
                            <a href="/statistik"
                                class="bg-[#3D7C17] hover:text-[#FFF100] md:bg-transparent {{ Route::currentRouteName() == 'statistik' ? 'text-white bg-[#3D7C17] text-sm' : 'text-white text-sm' }} rounded lg:bg-transparent  {{ Route::currentRouteName() == 'statistik' ? 'lg:text-[#FFF100]' : 'lg:text-grey-700' }} block pl-3 pr-4 py-2 md:p-0 rounded focus:outline-none">Statistik</a>
                        </li>
                        <li>
                            <a href="dokumentasi"
                ...
                <div class="items-center space-x-4 lg:flex">
                    <a href="/login"
                        class="bg-[#3D7C17] hover:text-[#FFF100] md:bg-transparent {{ Route::currentRouteName() == 'masuk' ? 'text-white bg-[#3D7C17] text-sm' : 'text-white text-md' }} rounded lg:bg-transparent  {{ Route::currentRouteName() == 'masuk' ? 'lg:text-[#FFF100]' : 'lg:text-grey-700' }} block pl-3 pr-4 py-2 md:p-0 rounded focus:outline-none font-bold">Masuk</a>
                </div>
            </div>
        </nav>
    </header>
